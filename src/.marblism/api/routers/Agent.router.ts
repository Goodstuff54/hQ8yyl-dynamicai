...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.AgentInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).agent.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.AgentInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).agent.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.AgentInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).agent.findFirst(input as any))),

        findMany: procedure.input($Schema.AgentInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).agent.findMany(input as any))),
